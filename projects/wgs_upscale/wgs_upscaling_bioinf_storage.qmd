...
fig.update_layout(margin=dict(t=0, l=0, r=0, b=0), height=900)
```
...
fig = go.Figure(
    data=[go.Box(y=analyses_work_dirs, boxpoints="all", name="analyses-work")]
)
fig.update_layout(
    title="Analysis work directories size (GB)",
    yaxis_title="Size (GB)",
    height=600,
    width=500,
    title_x=0.5,
...
fig.update_traces(hovertemplate="Size: %{y} GB")
fig.show()
```
