...
* The nsc-exporter is idle for quite a portion of the time @sec-idle-time.
    + [September](#attention-sep)'s effective transfer time[^effectivetime] is [`r r_tteffective_sep`]{style="font-family:Krona One;"} including [`r r_ttp_sep_wgs`]{style="font-family:Krona One"} wgs projects.
    + [October](#attention-oct)'s effective transfer time is [`r r_tteffective_oct`]{style="font-family:Krona One;"} including [`r r_ttp_oct_wgs`]{style="font-family:Krona One"} wgs projects.
    + [November](#attention-nov)'s effective transfer time is [`r r_tteffective_nov`]{style="font-family:Krona One;"} including [`r r_ttp_nov_wgs`]{style="font-family:Krona One"} wgs projects.
