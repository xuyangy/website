...
fig = px.scatter(py_df, x="bytes", y="speed", opacity=0.5)
fig.show()

fig_time = px.scatter(py_df, x="bytes", y="seconds", opacity=0.5)
fig_time.show()
```
...
fig_sf = px.scatter(small_files, x="bytes", y="speed", opacity=0.5)
fig_sf.show()

fig_sf_time = px.scatter(small_files, x="bytes", y="seconds", opacity=0.5)
fig_sf_time.show()
```
...
fig_200MB = px.scatter(small_files, x="bytes", y="speed", opacity=0.5)
fig_200MB.show()
```
