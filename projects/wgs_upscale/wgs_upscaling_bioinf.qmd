...
ggplot(
  ...
  labs(
    x = "file size (bytes)",
    y = "number of files (log10)",
    title = "File Size Distribution (log10 number of files)"
  ) +
...
ggplot(
  ...
  labs(
    x = "bytes/s",
    y = "number of files (log10)",
    title = "Transfer Speed (log10 number of files)"
  ) + 
  scale_y_continuous(trans = 'log10') +
  theme_minimal() + theme(plot.title = element_text(hjust = 0.5))
...
ggplot(
  ...
  labs(
    x = x_label,
    y = "number of files (log10)",
    title = "Transfer Time (log10 number of files)"
  ) +
  scale_y_continuous(trans = "log10") +
  theme_minimal() + theme(plot.title = element_text(hjust = 0.5))
